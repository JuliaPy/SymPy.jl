...
==#
function TermInterface.istree(x::SymPy.SymbolicObject)
    !(x.is_Atom)
end
...
==#
function TermInterface.exprhead(x::SymPy.SymbolicObject)
...
==#
function TermInterface.operation(x::SymPy.SymbolicObject)
    @assert istree(x)
...
==#
function TermInterface.arguments(x::SymPy.SymbolicObject)
